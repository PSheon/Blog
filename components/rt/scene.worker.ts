...
export interface BuildResult { triangles: number; nodeCount: number; depth: number; buildMs: number; nodes: ArrayBuffer; packed: ArrayBuffer; materials: Material[]; camera: Scene["camera"]; light?: Scene["light"]; normals?: ArrayBuffer; /** what a playground knows beyond its triangles */ playground?: Pick<Playground, "spawns" | "vehicleMaterials" | "characterMaterial">; error?: string }
