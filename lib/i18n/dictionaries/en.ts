...
const en: Dictionary = {
  ...
  search: {
    ...
    failed: "The search index failed to load. Check your connection.",
    retry: "Try again",
    latest: "The latest articles",
    posts: "All posts",
    tags: "Tags",
    navigate: "move",
    select: "open",
  ...
  hero: {
    ...
    think: { steps: "Training steps", input: "Problem", output: "The model writes", attention: "Which digit each answer looks at", again: "Train again" },
    generate: { note: "A replay of the diffusion process; no model runs here", again: "Play again" },
    act: { generation: "Generation", alive: "Still flying", best: "Most pipes", again: "Evolve again" },
  },
  home: {
    latest: "Latest",
