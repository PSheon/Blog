...
export const AlignLab = dynamic(() => labs().then((m) => m.AlignLab));
export const CloudLab = dynamic(() => labs().then((m) => m.CloudLab));
export const DriveLab = dynamic(() => labs().then((m) => m.DriveLab));
export const OutcomesLab = dynamic(() => labs().then((m) => m.OutcomesLab));
export const SpringsLab = dynamic(() => labs().then((m) => m.SpringsLab));
export const WheelsLab = dynamic(() => labs().then((m) => m.WheelsLab));
