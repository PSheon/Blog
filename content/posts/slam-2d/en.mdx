---
title: (Draft) SLAM from scratch, and the moment the map snaps straight
...
The good news is that this kind of doubt **can be computed**. The small equation ICP solves already carries "which directions am I sure about": it is the pink ellipse in the figure, a small circle at the corner and stretched along the corridor in the corridor. The car simply refuses any match whose ellipse is too flat.
