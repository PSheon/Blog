...
const zh = {
  ...
  legend: [
    { id: "foot", title: "走路", keys: [["W A S D", "移動"], ["Shift", "衝刺"], ["Space", "跳"], ["F", "搭上旁邊的載具"], ["拖曳", "轉動鏡頭"], ["Esc", "收合"]] },
...
const en: typeof zh = {
  ...
  legend: [
    { id: "foot", title: "On foot", keys: [["W A S D", "move"], ["Shift", "sprint"], ["Space", "jump"], ["F", "get into what is next to you"], ["drag", "turn the camera"], ["Esc", "collapse"]] },
  ...
  carry: "Carry the last frame over",
