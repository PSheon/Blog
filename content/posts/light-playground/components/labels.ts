...
const zh = {
  ...
  legend: [
    { id: "foot", title: "走路", keys: [["W A S D", "移動（方向鍵也可以）"], ["Shift", "衝刺"], ["Space", "跳"], ["F", "上車、上直升機、上飛機"], ["拖曳", "轉動鏡頭"], ["Esc", "收合"]] },
    { id: "car", title: "車", keys: [["W S", "油門、倒車"], ["A D", "方向"], ["Space", "煞車"], ["F", "下車"]] },
    { id: "heli", title: "直升機", keys: [["Space", "上升"], ["Shift", "下降"], ["W S", "前傾、後仰"], ["A D", "轉向"], ["F", "離開（在空中也可以）"]] },
  ...
  hint: "拖曳畫面轉動鏡頭。先點一下畫面，再用 W A S D 或方向鍵走路，Shift 衝刺，空白鍵跳；走到車、直升機或飛機旁按 F 上去，再按一次下來。車：同樣的鍵是油門、方向，空白鍵煞車。直升機：空白鍵上升、Shift 下降，前後鍵前傾後仰，左右鍵轉向，放手就懸停。飛機：按住空白鍵加油門，速度夠了把後鍵（S）按住拉起機頭，左右鍵壓坡度轉彎，Shift 煞車；手機用左下角的搖桿和右下角的「跳」。人一動，累積的樣本就全部作廢，畫面回到雜訊；站著不動，它就慢慢變清楚。",
};
...
const en: typeof zh = {
  ...
  legend: [
    { id: "foot", title: "On foot", keys: [["W A S D", "move (the arrow keys too)"], ["Shift", "sprint"], ["Space", "jump"], ["F", "get into a car, the helicopter, the aeroplane"], ["drag", "turn the camera"], ["Esc", "collapse"]] },
    { id: "car", title: "Car", keys: [["W S", "throttle, reverse"], ["A D", "steer"], ["Space", "brake"], ["F", "get out"]] },
    { id: "heli", title: "Helicopter", keys: [["Space", "climb"], ["Shift", "descend"], ["W S", "tilt forward, back"], ["A D", "turn"], ["F", "leave (in the air too)"]] },
