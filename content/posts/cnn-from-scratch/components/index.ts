...
export const ConvStepper = dynamic(() => labs().then((m) => m.ConvStepper));
export const DrawPredict = dynamic(() => labs().then((m) => m.DrawPredict));
export const FeatureMaps = dynamic(() => labs().then((m) => m.FeatureMaps));
export const KernelPlayground = dynamic(() => labs().then((m) => m.KernelPlayground));
export const OcclusionMap = dynamic(() => labs().then((m) => m.OcclusionMap));
