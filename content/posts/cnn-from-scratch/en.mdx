...
This model was trained with gradient descent. [The next entry](/en/posts/ai-flappy-bird) takes a completely different road: no gradients, no backpropagation, only survival of the fittest, as 50 birds teach themselves to play Flappy Bird.
