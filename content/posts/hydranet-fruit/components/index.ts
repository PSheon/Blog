...
export const HeadsRace = dynamic(() => labs().then((m) => m.HeadsRace));
export const LabelsFigure = dynamic(() => labs().then((m) => m.LabelsFigure));
export const TrainingLab = dynamic(() => labs().then((m) => m.TrainingLab));
