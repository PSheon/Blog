...
const zh = {
  ...
  heatUnit: "個節點", heatUnitBrute: "次三角形測試", testsPerRay: "每條光線測試的三角形", depth: "樹的深度", bvhOff: "關掉 BVH",
...
const en: typeof zh = {
  ...
  heatUnit: "nodes", heatUnitBrute: "triangle tests", testsPerRay: "Triangles tested per ray", depth: "Depth of the tree", bvhOff: "Turn the BVH off",
