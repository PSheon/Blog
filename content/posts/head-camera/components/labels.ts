...
const zh = {
  ...
  no3d: "這個瀏覽器開不了 3D 畫面（WebGL）。模型照常在跑：右上角是它看到的，左下角是它的進度。",
...
const en: typeof zh = {
  ...
  no3d: "This browser could not start the 3D view (WebGL). The model is running all the same: top right is what it sees, bottom left is how it is doing.",
