...
const zh = {
  ...
  overseer: "總覽", person: "誰", doing: "在做什麼", where: "在哪／去哪", needs: "疲勞・飢餓・社交・待辦",
  needsShort: "四條需求",
  needNames: ["疲勞", "飢餓", "社交", "待辦"],
  actionNouns: { work: "工作", eat: "吃飯", social: "社交", sleep: "回家休息", idle: "" },
...
const en: typeof zh = {
  ...
  overseer: "Overseer", person: "who", doing: "doing", where: "at / going to", needs: "fatigue · hunger · social · backlog",
  needsShort: "needs",
  needNames: ["fatigue", "hunger", "social", "backlog"],
  actionNouns: { work: "work", eat: "a meal", social: "time with people", sleep: "a rest at home", idle: "" },
