...
<Instrument fig="01" title="transformer / train" size="wide" caption="Choose “slow” to watch the change happen, or “fast” to finish training in a second or two. Press “Another one” for a different set of digits: training problems are generated at random every step, so the model has almost certainly never seen this one.">
  <TrainingLab />
</Instrument>
