...
export const GainsLab = dynamic(() => labs().then((m) => m.GainsLab));
export const PushLab = dynamic(() => labs().then((m) => m.PushLab));
export const RemoteLab = dynamic(() => labs().then((m) => m.RemoteLab));
export const SensesLab = dynamic(() => labs().then((m) => m.SensesLab));
