...
const zh = {
  ...
  pushLog: "紀錄",
  pushEmpty: "還沒推過。同樣的力道多推幾次，結果不一定一樣：要看推下去的瞬間，牠哪幾隻腳在地上。",
...
const en: typeof zh = {
  ...
  pushLog: "log",
  pushEmpty: "No shoves yet. Try the same force several times: the outcome depends on which feet are down at that instant.",
