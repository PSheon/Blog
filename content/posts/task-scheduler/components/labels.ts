...
const zh = {
  ...
  skew: "任務大小有多懸殊", skewLow: "都差不多", skewSome: "有大有小", skewHigh: "少數幾個特別大", skewExtreme: "幾乎全部的工作都在幾個任務裡",
...
const en: typeof zh = {
  ...
  skew: "How unequal the tasks are", skewLow: "all about the same", skewSome: "some big, some small", skewHigh: "a few huge ones", skewExtreme: "nearly all the work is in a few tasks",
