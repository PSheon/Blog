...
import { COMMIT, KERNEL, MEASURE, PRESENT, REPROJECT } from "@/lib/rt/kernel";
...
describe("the shaders", () => {
  for (const [name, code] of [["kernel", KERNEL], ["measure", MEASURE], ["present", PRESENT], ["commit", COMMIT], ["reproject", REPROJECT]] as const)
